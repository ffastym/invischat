...
const PrivacyPolicy = () => {
    return (
        <div className="page-content privacy-policy">
            ...
            <h4>2. Файли Cookies та збір і обробка інформації</h4>
            <p>
                Для ведення аналітики відвідування та сеансів користувачів у Чаті використовуються файли Cookies за рахунок яких з пристроїв
