...
const PrivacyPolicy = () => {
    return (
        <div className="page-content privacy-policy">
            ...
            <p>
                Цей документ описує політику конфіденційності для веб-додатку TerChat,
                розміщеного за веб-адресою <a href="http://www.invischat.com">https://www.invischat.com</a> (надалі – «Чат»).
