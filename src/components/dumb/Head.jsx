...
const Head = ({url}) => {
    let title = 'Invischat - Анонімний Чат',
        description = 'Анонімний чат з випадковим співрозмовником.',
        keywords = 'чат, анонімний чат, форум, lfyou, знайомства, підслухано, чат знайомства в україні, знакомства, некто, чат онлайн, chat, шукаю тебе, анонімний чат тз, тз, шт, анонімний чат іф, зізнання, анонімний форум, anonumous chat, чат невидимки, Invischat, анонімний чат, типове зізнання, шукаю тебе';
